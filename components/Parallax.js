...
function Parallax() {
    ...
    useEffect(() => {
        let ctx = gsap.context(() => {
            ...
            tl.to(copy.current, { y: "-150%", opacity: 1 }, 0);
    ...
    return (
        <div className="parallax-outer">
            <div ref={parallaxRef} style={{ background: `linear-gradient(#0F2B9C 0%, #673D7D ${background}%, #A74A67 75%, #EDFC54 85%, #282a57 100%)` }} className='parallax'>
